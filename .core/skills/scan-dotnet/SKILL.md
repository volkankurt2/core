...
{
  "projeler": [
    { "isim": "MyApp.Api", "dosya": "knowledge-base/myapp-api.json", "ozet": "HTTP giriş noktası", "kritiklik": "YUKSEK" },
    { "isim": "MyApp.Domain", "dosya": "knowledge-base/myapp-domain.json", "ozet": "Core iş mantığı", "kritiklik": "KRITIK" }
  ],
  "proje_bagimlilik_matrisi": { ... },
...
<rules>
  ...
  <r>knowledge-base/ klasörüne yazmak için mevcut dosya sistemi araçlarını kullan</r>
